...
function Header({}: Props) {
  const conenectWithMetamask = useMetamask();
  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      <nav className="flex  justify-between">
        <div className="flex items-center space-x-2 text-sm">
          {address ? (
            ...
            <button onClick={conenectWithMetamask} className="connectWalletBtn">
              Connect your Wallet
            </button>
          )}
      ...
      <section className="flex items-baseline space-x-2 py-5 ">
        ...
        <button className="lf:flex hidden items-center space-x-2 w-20 ">
