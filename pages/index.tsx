...
const Home = () => {
  ...
  return (
    <div className="">
      <Header />
      <main className="mac-w-6xl mx-auto py-2 px-6 ">
        {loadingListings ? (
            ...
            {listings?.map((listing) => (
              ...
              >
                ...
                <div  className="py-2 space-y-4">
                  ...
                  <p>
                    <span className="font-bold mr-1">{listing.buyoutCurrencyValuePerToken.displayValue}
                    <span>{listing.buyoutCurrencyValuePerToken.symbol}</span>
                    </span>
                  </p>

                  <div className={`flex items-center space-x-1 justify-end text-xxs border w-fit  ml-auto p-2 rounded-lg text-white ${listing.type === ListingType.Direct ? "bg-blue-500" : "bg-red-500"}`} >
                    <p>
